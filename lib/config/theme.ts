...
export const alphabetNav = {
  card: 'fixed right-0.5 top-1/2 -translate-y-1/2 z-50 flex flex-col items-center py-1 px-0.5 select-none touch-none rounded-lg bg-slate-800/70 border border-slate-600/30 shadow-lg backdrop-blur-sm',
  bubble: 'w-12 h-12 rounded-xl flex items-center justify-center bg-slate-800 border border-slate-600/50 shadow-lg',
  letter: 'text-lg font-bold transition-colors w-6 h-6 flex items-center justify-center',
