...
export const alphabetNav = {
  card: 'fixed right-1 top-1/2 -translate-y-1/2 z-50 flex flex-col items-center py-2 px-1.5 select-none touch-none rounded-xl bg-slate-800/70 border border-slate-600/30 shadow-lg backdrop-blur-sm',
  bubble: 'w-12 h-12 rounded-xl flex items-center justify-center bg-slate-800 border border-slate-600/50 shadow-lg',
  letter: 'text-[11px] font-semibold transition-colors w-5 h-4 flex items-center justify-center',
