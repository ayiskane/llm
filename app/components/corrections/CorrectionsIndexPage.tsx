...
const getRegionInfo = (centre: CorrectionalCentre) => ({
  id: centre.region_id ?? 0,
  code: centre.region_code ?? "UNK",
  name: centre.region_name ?? "Unknown",
});

const isFederal = (centre: CorrectionalCentre) =>
  centre.type_id === CENTRE_TYPE.FEDERAL;
