  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        "rounded-xl border border-border/60 bg-card p-4 shadow-xl",
        className,
      )}
      {...props}
    >
      {children}
      <DialogClose className="absolute right-3 top-3 rounded-md p-1 text-muted-foreground hover:text-foreground">
